...
class Board {
	...
	public:
		...
		bool checkMove(Move m, int color, bool onlyTesting = false, char *capture = nullptr, bool *check_move = nullptr, bool *checkmate_move = nullptr, bool *castle_move = nullptr, bool *is_promotion = nullptr, bool *is_enPassant = nullptr);
